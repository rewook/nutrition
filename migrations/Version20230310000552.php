 ...
 */
final class Version20230310000552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, recette_id INT NOT NULL, description LONGTEXT NOT NULL, note INT NOT NULL, INDEX IDX_8F91ABF06B899279 (patient_id), INDEX IDX_8F91ABF089312FE9 (recette_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
